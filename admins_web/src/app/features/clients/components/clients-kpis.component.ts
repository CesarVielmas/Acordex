    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
      ...
      <div class="p-5 rounded-3xl bg-[#181818] border border-primary/30 shadow-xl relative overflow-hidden group hover:border-primary/50 transition-all duration-300">
        <div class="flex items-center justify-between gap-2 mb-2">
          <span class="text-[10px] font-black text-primary uppercase tracking-widest font-['Epilogue']">Cartera Registrada</span>
        ...
        <div class="space-y-1">
          ...
          <p class="text-[11px] text-outline font-['Epilogue']">{{ kpis()?.frequentClientsCount || 0 }} cuentas recurrentes</p>
        </div>
      </div>
      ...
      <div class="p-5 rounded-3xl bg-[#181818] border border-cyan-500/30 shadow-xl relative overflow-hidden group hover:border-cyan-500/50 transition-all duration-300">
        <div class="flex items-center justify-between gap-2 mb-2">
          <span class="text-[10px] font-black text-cyan-400 uppercase tracking-widest font-['Epilogue']">Cuentas Clave / Diamante</span>
        ...
        <div class="space-y-1">
          ...
          <p class="text-[11px] text-cyan-200 font-['Epilogue']">Empresarios de alta frecuencia</p>
        </div>
      </div>
      ...
      <div class="p-5 rounded-3xl bg-[#181818] border border-emerald-500/30 shadow-xl relative overflow-hidden group hover:border-emerald-500/50 transition-all duration-300">
        <div class="flex items-center justify-between gap-2 mb-2">
          <span class="text-[10px] font-black text-emerald-400 uppercase tracking-widest font-['Epilogue']">Facturación Histórica</span>
        ...
        <div class="space-y-1">
          ...
          <p class="text-[11px] text-emerald-400 font-['Epilogue']">Colocado en contrataciones</p>
        </div>
      </div>
      ...
      <div class="p-5 rounded-3xl bg-[#181818] border border-purple-500/30 shadow-xl relative overflow-hidden group hover:border-purple-500/50 transition-all duration-300">
        <div class="flex items-center justify-between gap-2 mb-2">
          <span class="text-[10px] font-black text-purple-300 uppercase tracking-widest font-['Epilogue']">Ticket Promedio</span>
        ...
        <div class="space-y-1">
          ...
          <p class="text-[11px] text-purple-200 font-['Epilogue']">Por contratación confirmada</p>
        </div>
      </div>
      ...
      <div class="p-5 rounded-3xl bg-[#181818] border border-amber-500/30 shadow-xl relative overflow-hidden group hover:border-amber-500/50 transition-all duration-300">
        <div class="flex items-center justify-between gap-2 mb-2">
          <span class="text-[10px] font-black text-amber-400 uppercase tracking-widest font-['Epilogue']">Índice de Recontratación</span>
        ...
        <div class="space-y-1">
          ...
          <p class="text-[11px] text-amber-200 font-['Epilogue']">Tasa de fidelidad comercial</p>
        </div>
      </div>
